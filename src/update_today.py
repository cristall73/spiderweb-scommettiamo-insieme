...
def load_live_rules():
    ...
    # Elimina duplicati quasi equivalenti: nel live basta che una regola robusta corrisponda.
    ...
    for e in events:
        ...
        for m in e.get('markets',[]):
            ...
            for o in m['options']:
                ...
                # Ulteriore cintura di sicurezza: EV deve essere positivo anche usando la quota corrente.
                if ev<=0:
                    continue
...
def main():
    ...
    # Storico -> modello live. Usa solo risultati già conclusi presenti nella fonte storica.
